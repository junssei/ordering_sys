                        ...
                        <div class="orderitem_container">
                            <div class="orderitem_subcontainer">
                                ...
                                <table id="orderitem_table">
                                    ...
                                    <?php
                                    $fetchOrderProduct = "SELECT * FROM order_product LEFT JOIN product_variation ON order_product.variation_id = product_variation.variation_id WHERE order_id = {$row['order_id']}";
                                    ...
                                    ?>
                                        <tr class="orderitemtable_row">
                                            ...
                                            <td> &#8369;<?= $rowOrdProd['price'] ?> x <?= $rowOrdProd['quantity'] ?> </td>
                                            <?php $totalPrice = $rowOrdProd['quantity'] * $rowOrdProd['price'];  ?>
                                            <td> &#8369;<?= $totalPrice ?> </td>
                                        </tr>
                                    <?php
                                    }
