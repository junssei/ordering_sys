...
function deleteCart(id, user) {
  ...
  xhttp.open(
    "GET",
    "process/cart_process.php?cartItem=" + id + "&uid=" + user,
    true
  );
  xhttp.send();
}
...
function updateCartVariation(id, value) {
  ...
  xhttp.open(
    "GET",
    "process/cart_process.php?variation=" + id + "&value=" + value,
    true
  );
  xhttp.send();
}
...
function updateCartQuantity(id, value) {
  ...
  xhttp.open(
    "GET",
    "process/cart_process.php?quantity=" + id + "&value=" + value,
    true
  );
  xhttp.send();
}
