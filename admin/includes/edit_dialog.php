...
if ($rowPrd = mysqli_fetch_assoc($result)) {
    ...
    <div class="dialog_container">
        <div id="dialog_header">
            <h1>Edit Product</h1>
            <img class="close_editprd_dialog" src="../source/images/icon/svg/close.svg" alt="closebtn">
        </div>
        <form id="editproduct" class="dialog_form" action="" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="inputfile" style="border: none;">
                <img src="../source/images/upload/products/<?= htmlspecialchars($rowPrd['prd_filename']) ?>" class="imagedisp imageMedium">
                <div class="inp inpfile">
                    <input class="imageupld choosefilebtn" type="file" name="uploadimg1" accept=".png, .jpg, .jpeg">
                </div>
            </div>
            <div class="input_actions">
                <input class="enabledbtn defaultbtn" type="submit" value="Update" name="submit_product">
            </div>
        </form>
    </div>
    <?php
